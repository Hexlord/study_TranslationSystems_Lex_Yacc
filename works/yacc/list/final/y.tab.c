...
#define LETTER 259
#define INT 260
#define DOUBLE_PLUS 261
#define DOUBLE_MINUS 262
...
static const yytype_uint8 yytranslate[] =
{
       ...
       8,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,    17,     2,     2,     2,     2,     2,    10,     2,
      12,    13,    11,    14,     2,    15,     2,    16,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     9,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    67,    67,    68,    69,    73,    78,    79,    83,    84,
      85,    86,    87,    88,    89,    90,    91,    95,    96,    97,
      98,   102,   103,   104,   105,   106,   110,   111,   112,   121,
     122
};
#endif
...
{
  "$end", "error", "$undefined", "DIGIT", "LETTER", "INT", "DOUBLE_PLUS",
  "DOUBLE_MINUS", "'\\n'", "'='", "'&'", "'*'", "'('", "')'", "'+'", "'-'",
  "'/'", "' '", "'['", "']'", "$accept", "line", "statement", "right",
  "right_elem", "op", "left", "id", "number", YY_NULLPTR
};
#endif
...
{
       3,    -8,    25,     8,     5,    -8,    -7,     0,     2,     8,
      34,    -8,    -8,    -8,    19,    -8,    -8,    21,     8,    34,
      -8,    -8,    -8,     8,     8,    -8,    -8,    -8,    -8,    -8,
      19,    -8,    -8,    34,    36,    -2,    34,    34,    34,    -8,
      -8,    -8
};
...
{
       0,    26,     0,     0,     0,     2,     0,    25,     0,     0,
      22,     1,     4,     3,     0,    28,    27,     0,     0,    23,
      29,     8,     9,     0,    19,    15,    16,    17,    18,    20,
       5,     6,    10,    14,    11,     0,    21,    12,    13,     7,
      30,    24
};
...
{
      -8,    -8,    24,    -8,    10,    -8,    -8,    -3,    26
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,    30,    31,    32,     6,     7,    34
};
...
{
      10,    40,    14,    15,    16,    11,    19,     1,     2,     1,
       2,    33,     1,    12,     3,    36,     3,    41,    17,    18,
      37,    38,    20,     1,    20,    21,    22,    33,    13,    23,
      24,    25,    26,    27,    28,    29,     8,    15,    16,    40,
      39,     0,     9,    35
};
...
{
       3,     3,     9,     3,     4,     0,     9,     4,     5,     4,
       5,    14,     4,     8,    11,    18,    11,    19,    18,    17,
      23,    24,     3,     4,     3,     6,     7,    30,     4,    10,
      11,    12,    13,    14,    15,    16,    11,     3,     4,     3,
      30,    -1,    17,    17
};
...
{
       0,     4,     5,    11,    21,    22,    26,    27,    11,    17,
      27,     0,     8,    22,     9,     3,     4,    18,    17,    27,
       3,     6,     7,    10,    11,    12,    13,    14,    15,    16,
      23,    24,    25,    27,    28,    28,    27,    27,    27,    24,
       3,    19
};
...
#line 102 "c.y" /* yacc.c:1646  */
    {statement_type = 3; statement_variable = strdup(id_buffer);}
#line 1370 "y.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 103 "c.y" /* yacc.c:1646  */
    {statement_type = 4; statement_variable = strdup(id_buffer);}
#line 1376 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 104 "c.y" /* yacc.c:1646  */
    {statement_type = 2; statement_variable = strdup(id_buffer);}
#line 1382 "y.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 105 "c.y" /* yacc.c:1646  */
    {statement_type = 1; statement_assignment_array_offset = current_number; statement_variable = strdup(id_buffer);}
#line 1388 "y.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 106 "c.y" /* yacc.c:1646  */
    {statement_type = 0; statement_variable = strdup(id_buffer);}
#line 1394 "y.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 110 "c.y" /* yacc.c:1646  */
    {id_length = 0; id_buffer[id_length++] = (yyvsp[0].character); id_buffer[id_length] = 0;}
#line 1400 "y.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 111 "c.y" /* yacc.c:1646  */
    {id_buffer[id_length++] = (yyvsp[0].character); id_buffer[id_length] = 0;}
#line 1406 "y.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 112 "c.y" /* yacc.c:1646  */
    {id_buffer[id_length++] = (yyvsp[0].digit) + '0'; id_buffer[id_length] = 0;}
#line 1412 "y.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 121 "c.y" /* yacc.c:1646  */
    {current_number = (yyvsp[0].digit);}
#line 1418 "y.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 122 "c.y" /* yacc.c:1646  */
    {current_number = current_number * 10 + (yyvsp[0].digit);}
